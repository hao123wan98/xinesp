...
(function(obj) {
    ...
    function _buildModal(opt) {
        ...
        //// 构建容器
        var _container = $('<div zero-unique-container="' + opt.unique + '" class="zeromodal-container" style="z-index:' + _tmp_last_zindex + ';width:' + _width + 'px;height:' + _height + 'px;left:' + _left + 'px;top:' + (opt.transition ? _top - 50 : _top) + '"></div>');
        ...
        //// 构建头部
        if(opt.titleCenter){
            var _headerHtml = '<div zeromodal-unqiue-header="' + opt.unique + '" class="zeromodal-header-center">';
        }else{
